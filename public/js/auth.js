...
/* harmony import */ var _newMessage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./newMessage */ "./resources/js/newMessage.js");
...
document.querySelectorAll('.auth-form').forEach(function (form) {
  form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var form, formData, postData, result, data, container;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return axios.post(form.action, postData, {
              headers: {
                'Content-Type': 'application/json'
              }
            });
          case 7:
            ...
            data = result.data;
            container = document.querySelector('.form-login-body');
            if (container.querySelector('.alert')) container.querySelector('.alert').remove();
            document.querySelector('.form-login-body').prepend((0,_newMessage__WEBPACK_IMPORTED_MODULE_1__.newMessage)(data.message, data.type));
            if (data.status == true) {
