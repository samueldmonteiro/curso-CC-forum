...
(0,_utils__WEBPACK_IMPORTED_MODULE_2__.qs)('.form-login').addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          data = result.data;
          container = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.qs)('.form-body');
          if (container.querySelector('.alert')) container.querySelector('.alert').remove();
          (0,_utils__WEBPACK_IMPORTED_MODULE_2__.qs)('.form-login-body').prepend((0,_alert__WEBPACK_IMPORTED_MODULE_1__["default"])(data.message, data.type));
          if (data.status == true) {
