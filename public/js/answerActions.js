...
var modalAnswerDelete = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)("#modalDeleteAnswer");
if ((0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)(".answer-item")) {
  (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qsAll)(".answer-item").forEach(function (answerItem) {
    ...
    if (buttonDeleteAnswer) {
      buttonDeleteAnswer.addEventListener("click", function (e) {
...
function answerDelete() {
  return _answerDelete.apply(this, arguments);
}
function _answerDelete() {
  _answerDelete = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          axios["delete"](modalAnswerDelete.dataset.url, {
            data: data,
            headers: {
            ...
            modalAnswerDelete.prepend((0,_alert__WEBPACK_IMPORTED_MODULE_1__["default"])(error.response.data.message, 'error'));
          });
        case 2:
        case "end":
...
if ((0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)(".answer-item")) {
  (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qsAll)('#like-answer').forEach(function (likeArea) {
