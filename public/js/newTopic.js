...
var topicModal = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('#modal-topic');
topicModal.querySelector('form').addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var topicData, resp, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return axios.post(this.action, topicData, {
            headers: {
        ...
        case 5:
          ...
          topicModal.querySelector('.modal-body').prepend((0,_alert__WEBPACK_IMPORTED_MODULE_1__["default"])(data.message, data.type));
          if (data.type == 'info') {
